  ...
  const shops = [
    {
      ...
      sms: `sms:0507-1280-3167?body=안녕하세요, ${currentDistrictName} 출장마사지 예약 문의드립니다.`
    },
    {
      id: 2,
      category: 'thai',
      ...
      sms: `sms:0507-1280-3169?body=안녕하세요, ${currentDistrictName} 홈타이 예약 문의드립니다.`
    },
    {
      id: 3,
      category: 'aroma',
      ...
      title: `${currentDistrictName} 딥아로마 홈케어`,
      rating: '4.95',
      ...
      sms: `sms:0507-1280-3170?body=안녕하세요, ${currentDistrictName} 아로마 예약 문의드립니다.`
    },
    {
      id: 4,
      category: 'homecare',
      ...
      sms: `sms:0507-1280-3171?body=안녕하세요, ${currentDistrictName} 프리미엄 홈케어 문의드립니다.`
    },
    {
      id: 5,
      category: 'thai',
      ...
      sms: `sms:0507-1280-3172?body=안녕하세요, ${currentDistrictName} 24시 마사지 문의드립니다.`
    }
  ];
