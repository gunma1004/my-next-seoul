...
export default function DistrictClientPage({ districtKey }) {
  ...
  const shops = [
    {
      id: 1, category: 'swedish', subTitle: '한국미인홈케어', title: `${currentDistrictName} 프리미엄 스웨디시`,
      ...
      phone: 'tel:0507-1280-3167', sms: `sms:0507-1280-3167?body=안녕하세요, ${currentDistrictName} 출장 예약 문의드립니다.`
    },
    {
      ...
      phone: 'tel:0507-1280-3169', sms: `sms:0507-1280-3169?body=안녕하세요, ${currentDistrictName} 홈타이 예약 문의드립니다.`
    },
    {
      id: 3, category: 'aroma', subTitle: 'VIP 에센셜 홈케어', title: `${currentDistrictName} 딥아로마 홈케어`,
      ...
      phone: 'tel:0507-1280-3170', sms: `sms:0507-1280-3170?body=안녕하세요, ${currentDistrictName} 아로마 예약 문의드립니다.`
    },
    {
      id: 4, category: 'homecare', subTitle: '한국꿀홈케어', title: 'VIP 감성 슈크림 아로마',
      desc: `최상의 보습을 자랑하는 특제 슈크림 로션과 에센셜 아로마 오일을 혼합한 프리미엄 패키지 서비스.`,
      img: 'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&w=800&q=80',
      phone: 'tel:0507-1280-3171', sms: `sms:0507-1280-3171?body=안녕하세요, ${currentDistrictName} 프리미엄 문의드립니다.`
    },
    {
      ...
      img: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=800&q=80',
      phone: 'tel:0507-1280-3172', sms: `sms:0507-1280-3172?body=안녕하세요, ${currentDistrictName} 24시 마사지 문의드립니다.`
    }
  ];
